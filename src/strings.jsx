const strings = {
    "en": {
        ...
        news: {
            ...
            UselessButlerCharacterCompetition: "Useless Butler started a character model competition with 5 remarkable submissions...",
            Sofdec2Discoveries: "Sofdec2 USM modding has been made easier than ever thanks to our discovery of various tools..."
        },
    ...
    "es": {
        ...
        news: {
            see: "leer",
            more: "más",
            NewWebsiteLaunch: "¡Estamos orgullosos de anunciar el inicio de nuestra web nueva a jojomodding.com, nuestro portal oficial!",
            AsbrModdingComesToNintendoSwitch: "Hemos visto un gran avance para los jugadores de ASBR en Nintendo Switch...",
            UselessMaidLisaLisaCompetition: "Organizamos un concurso de texturas para la Lisa Lisa solitaria, financiado por Useless Maid...",
            UselessButlerCharacterCompetition: "Useless Butler inició una competencia de modelos y hay 5 presentaciones geniales...",
            Sofdec2Discoveries: "El modding de Sofdec2 se ha hecho súper fácil gracias al descubrimiento de varias herramientas..."
        },
    ...
    "sv": {
        ...
        news: {
            see: "Kolla",
            more: "Mera",
            NewWebsiteLaunch: "Vi är stolta över att tillkännage lanseringen av vår nya webbplats på jojomodding.com, vår officiella portal!",
            AsbrModdingComesToNintendoSwitch: "Vi har sett ett enormt genombrott för ASBR-spelare på Nintendo Switch...",
            UselessMaidLisaLisaCompetition: "Tidigare sällan moddad, vi höll en Lisa Lisa texturtävling, finansierad av Useless Maid...",
            UselessButlerCharacterCompetition: "Useless Butler startade en karaktärsmodelltävling med 5 anmärkningsvärda bidrag...",
            Sofdec2Discoveries: "Sofdec2 USM modding har gjorts enklare än någonsin tack vare vår upptäckt av olika verktyg..."
        },
    ...
    "ja": {
        ...
        news: {
            see: "もっと",
            more: "見る",
            NewWebsiteLaunch: "私たちはNintendo SwitchのASBRプレイヤーにとって大きなディスカバリーを見られました！",
